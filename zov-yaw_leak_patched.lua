...
OverrideSkeet = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Enable FUCK Z")
Tabs = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Tabs",{"Anti-Aim","Visuals", "Misc", "Config"})
...
BodyYawOnE = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Body Yaw On Use")
Builder = {}
Builder.Conditions = {"General","Stand","Slow walk","Move","Duck","Aerobic","Aerobic+"}
ManualLeft = ui.new_hotkey('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Manual Left")
ManualRight = ui.new_hotkey('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Manual Right")
ManualForward = ui.new_hotkey('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Manual Forward")
Freestand = ui.new_hotkey('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Freestand")
Builder.ConditionSelect = ui.new_combobox('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Condition", Builder.Conditions)
Hitlogs = ui.new_multiselect('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Hitlogs", {"Hit","Miss"})
Windows = ui.new_multiselect('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Windows", {"Min damage indicator"})
kibit = ui.new_checkbox('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Kibit")
Indicators = ui.new_checkbox('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Other")
indicators_color = ui.new_color_picker('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF)Other Color", 255, 217, 102, 255)
AvoidBack = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Avoid Backstab")
ForceDefense = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Force Defense In Air")
ForceDefenseKey = ui.new_hotkey("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Force Defense on Key")
settingsindicators = ui.new_checkbox('AA', 'Anti-aimbot angles', '\a2986CCFFFUCK ".."\aFFD966FFRUSSIA\aFFFFFFFF - \aFFFFFFFFIndicators')
settingsindicators_color = ui.new_color_picker('AA', 'Anti-aimbot angles', '\nIndicators color', 255, 217, 102, 255)
settingsminimum_damage_override_indicator = ui.new_checkbox('AA', 'Anti-aimbot angles', '\a2986CCFFFUCK ".."\aFFD966FFRUSSIA\aFFFFFFFF - \aFFFFFFC8Minimum damage override indicator'); ui.set_visible(settingsminimum_damage_override_indicator, false)
...
settingsdisableshadows = ui.new_checkbox('AA', 'Anti-aimbot angles', '\a2986CCFFFUCK ".."\aFFD966FFRUSSIA\aFFFFFFFF - \aFFFFFFFFDisable shadows'); ui.set_visible(settingsdisableshadows, true)
...
for i = 1, #Builder.Conditions do
    ...
    Builder[i]["Enable"] = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Enable "..Builder.Conditions[i])
    Builder[i]["AllowFreestand"] = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Allow Freestand "..Builder.Conditions[i])
    Builder[i]["Pitch"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Pitch",{'Off', 'Default', 'Up', 'Down', 'Minimal', 'Random', 'Custom','\aFF5F5FFF Exploit'})
    Builder[i]["PitchVal"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Pitch",-89,89,0)
    Builder[i]["Yaw Base"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw Base",{'Local view', 'At targets'})
    Builder[i]["Yaw"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw",{'Off', '180', 'Spin', 'Static', '180 Z', 'Crosshair'})
    Builder[i]["YawOff"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw Offset",{"Default","Switch Between"})
    Builder[i]["YawOffVal"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw Offset Right", -180, 180, 0)
    Builder[i]["YawOffInv"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw Offset Left", -180, 180, 0)
    Builder[i]["YawOffHz"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Switches/sec", 1, 360, 144)
    Builder[i]["YawMod"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Yaw Modifier",{ 'Off', 'Offset', 'Center', 'Random', 'Skitter', "X-Way"})
    Builder[i]["ModAngle"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."]  Modifier Right", -180, 180, 0)
    Builder[i]["ModAngleInv"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Modifier Left", -180, 180, 0)
    Builder[i]["Ways"] = ui.new_slider("AA", "Anti-aimbot angles", "["..i.."] Ways",1,5)

    Builder[i]["WayHz"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF)".." ["..i.."] Way Switches/sec",1,360,144)
    for xi = 1, 5 do
        Builder[i]["Way"..xi] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF["..i.."]"..xi.."Way", -180, 180, 0)
    end

    Builder[i]["BodyYaw"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Body Yaw",{ 'Off', 'Opposite', 'Jitter', 'Static'})
    Builder[i]["BodyYawC"] = ui.new_combobox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Body Limit",{ "Static","Jitter L-R"})
    Builder[i]["BYawOffVal"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Body Yaw Right", -180, 180, 0)
    Builder[i]["BYawOffInv"] = ui.new_slider("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."] Body Yaw Left", -180, 180, 0)
    Builder[i]["FreestandBody"] = ui.new_checkbox("AA", "Anti-aimbot angles", "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF".." ["..i.."]  Freestand")
end
...
function hit(e)
    ...
    if ui.get(menu.console) then
        ...
        client.color_log(r, g, b, "[FUCK Z-YAW] \0")
...
local function indicators_rendering()
    ...
    renderer.text(x / 2 - 30 + math.floor(indicators_add_x), y / 2 + 17, 255, 255, 255, 255, 'd', 0, ' FUCK Z')
...
killsay = ui.new_checkbox('AA', 'Anti-aimbot angles', "".."\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Killsay")
...
local function player_death(e)
    ...
    if (x == 5) then
        client_exec("say get good get FUCK Z-YAW")
    end
    if (x == 6) then
        client_exec("say 1")
    end
...
clantag = ui.new_checkbox("AA", "Anti-aimbot angles", "\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Clantag")
local clantag_table = { }
...
fastladder = ui.new_multiselect("AA", "Anti-aimbot angles", "\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Fast ladder", "Up", "Down")
...
animation = ui.new_multiselect("AA", "Anti-aimbot angles", "\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF Animations", options)
...
setconsole = ui.new_checkbox("AA", "Anti-aimbot angles", "\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - Filter console")
...
enableRoundTime = ui.new_checkbox("AA", "Anti-aimbot angles", "\a2986CCFFFUCK ".."\aFFD966FFRUSSIA".."\aFFFFFFFF - disable AA on warmup")
