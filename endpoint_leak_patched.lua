...
local ui_dynamicFOVMin = e_UISlider:init("Minimum FOV", "°", 1, 180, false, UI_CHILD_BLOCK_WIDTH, UI_CHILD_BLOCK_HEIGHT);
local ui_dynamicFOVMax = e_UISlider:init("Maximum FOV", "°", 1, 180, false, UI_CHILD_BLOCK_WIDTH, UI_CHILD_BLOCK_HEIGHT);
