...
local tab_coded = ui.new_combobox(tab, place, "starlight leak patched", {"AA","AA2","Visuals","Misc","Config"})
...
local function new_menu_visibility()
   ...
   -- ui.set_visible(new_menu_references["aa"].aa_label,ui_menu.selected_tab == 1)
    ui.set_visible(new_menu_references["aa"].aa_state_menu,ui.get(tab_coded) == "AA" or ui.get(tab_coded) == "AA2" and jitter_page)
    ui.set_visible(new_menu_references.aa_tab,ui.get(tab_coded) == "AA2")
    
    --local anti_bruteforce = ui.get(new_menu_references["aa"]_tab) == "bruteforce"
    for k,v in ipairs(aa.aa_states) do
        ui.set_visible(new_menu_references["aa"].aa_state[v].enabled,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v)
        ui.set_visible( new_menu_references["aa"].aa_state[v].pitch,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v)
        ui.set_visible( new_menu_references["aa"].aa_state[v].pitch_slider,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].pitch) == "custom")
        ui.set_visible( new_menu_references["aa"].aa_state[v].yawbase,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and not manual_page) 
        ui.set_visible( new_menu_references["aa"].aa_state[v].yaw,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and v ~= "legit" and v ~= "manual") 
        ui.set_visible( new_menu_references["aa"].aa_state[v].yawadd,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and not manual_page and ui.get(new_menu_references["aa"].aa_state[v].yaw) ~= "off") 
        ui.set_visible( new_menu_references["aa"].aa_state[v].yawjitter,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v)  
        ui.set_visible( new_menu_references["aa"].aa_state[v].yawjitteradd,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) ~= "off" and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) ~= "jitter ways" and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) ~= "sway")  
        ui.set_visible( new_menu_references["aa"].aa_state[v].yawjitteradd2,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) == "l & r")  
        ui.set_visible( new_menu_references["aa"].aa_state[v].gs_bodyyaw,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v) 
        ui.set_visible( new_menu_references["aa"].aa_state[v].delayed_method,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].gs_bodyyaw) == "delayed yaw") 
        ui.set_visible( new_menu_references["aa"].aa_state[v].gs_bodyyawadd,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].gs_bodyyaw) ~= "off" and ui.get(new_menu_references["aa"].aa_state[v].gs_bodyyaw) ~= "anti bruteforce" and ui.get(new_menu_references["aa"].aa_state[v].gs_bodyyaw) ~= "auto jitter" and  ui.get(new_menu_references["aa"].aa_state[v].gs_bodyyaw) ~= "delayed yaw") 
        ui.set_visible( new_menu_references["aa"].aa_state[v].edgeyaw,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and not manual_page) 
        ui.set_visible( new_menu_references["aa"].aa_state[v].roll,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v) 
        ui.set_visible(new_menu_references["aa"].aa_state[v].jway_counter,false)
        ui.set_visible(new_menu_references["aa"].aa_state[v].swaym, ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) == "sway")
        ui.set_visible(new_menu_references["aa"].aa_state[v].swaymx, ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) == "sway")
        ui.set_visible(new_menu_references["aa"].aa_state[v].swayspeed, ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yawjitter) == "sway")

        if  v ~= "legit" and v ~= "manual" then
            ui.set_visible(new_menu_references["aa"].aa_state[v].yawaddleft, ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and (ui.get(new_menu_references["aa"].aa_state[v].yaw) == "jittery" or ui.get(new_menu_references["aa"].aa_state[v].yaw) == "delayed" or ui.get(new_menu_references["aa"].aa_state[v].yaw) == "l & r"))
            ui.set_visible(new_menu_references["aa"].aa_state[v].ticker_slider, ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yaw) == "delayed")
        end
        
        if v ~= "fakelag" and v ~= "legit" and v ~= "manual" then
            ui.set_visible(new_menu_references["aa"].aa_state[v].enabled_exploit,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v)
            ui.set_visible( new_menu_references["aa"].aa_state[v].enabled_defensive_force,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit)) 
            ui.set_visible( new_menu_references["aa"].aa_state[v].pitch_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit))
            ui.set_visible( new_menu_references["aa"].aa_state[v].pitch_custom_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].pitch_defensive) == "custom" and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit))
            ui.set_visible( new_menu_references["aa"].aa_state[v].yaw_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit)) 
            ui.set_visible( new_menu_references["aa"].aa_state[v].yawadd_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].yaw_defensive) ~= "off" and ui.get(new_menu_references["aa"].aa_state[v].yaw_defensive) ~= "randomize" and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit)) 
            ui.set_visible( new_menu_references["aa"].aa_state[v].skitter_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit)) 
            ui.set_visible(new_menu_references["aa"].aa_state[v].skitter_slider_defensive,ui.get(tab_coded) == "AA" and ui.get(new_menu_references["aa"].aa_state_menu) == v and ui.get(new_menu_references["aa"].aa_state[v].skitter_defensive) and ui.get(new_menu_references["aa"].aa_state[v].enabled_exploit))
        end

        ui.set_visible(new_menu_references["aa"].label_jitter_ways,ui.get(tab_coded) == "AA2" and jitter_page and ui.get(new_menu_references["aa"].aa_state[ui.get(new_menu_references["aa"].aa_state_menu)].yawjitter) ~= "jitter ways")
        for i = 1, 12 do
            ui.set_visible( new_menu_references["aa"].aa_state[v].pedro_aas2[i]  ,ui.get(tab_coded) == "AA2" and ui.get(new_menu_references["aa"].aa_state_menu) == v and i <= ui.get(new_menu_references["aa"].aa_state[v].jway_counter) and jitter_page and ui.get(new_menu_references["aa"].aa_state[ui.get(new_menu_references["aa"].aa_state_menu)].yawjitter) == "jitter ways")
    ...
    ui.set_visible(new_menu_references["aa"].freestanding_disabler, ui.get(tab_coded) == "AA2" and main_page)
    ui.set_visible(new_menu_references["aa"].freestanding_options, ui.get(tab_coded) == "AA2" and main_page)
    ui.set_visible(jitter_add, ui.get(tab_coded) == "AA2" and jitter_page and ui.get(new_menu_references["aa"].aa_state[ui.get(new_menu_references["aa"].aa_state_menu)].yawjitter) == "jitter ways" )
    ui.set_visible(jitter_remove, ui.get(tab_coded) == "AA2" and jitter_page and ui.get(new_menu_references["aa"].aa_state[ui.get(new_menu_references["aa"].aa_state_menu)].yawjitter) == "jitter ways")
    ui.set_visible(new_menu_references["keys"].enable_key, ui.get(tab_coded) == "AA2" and main_page)
    ui.set_visible(new_menu_references["keys"].manual_forward, ui.get(tab_coded) == "AA2" and main_page and keys)
    ui.set_visible(new_menu_references["keys"].manual_left, ui.get(tab_coded) == "AA2" and main_page and keys)
    ui.set_visible(new_menu_references["keys"].manual_right, ui.get(tab_coded) == "AA2" and main_page and keys)
    ui.set_visible(new_menu_references["keys"].manual_reset, ui.get(tab_coded) == "AA2" and main_page and keys)
    ui.set_visible(new_menu_references["keys"].global_fs, ui.get(tab_coded) == "AA2" and main_page and keys)
    ui.set_visible(new_menu_references["aa"].anti_kniv, ui.get(tab_coded) == "AA2" and main_page)
    ui.set_visible(new_menu_references["aa"].safe_dangerous, ui.get(tab_coded) == "AA2" and main_page)
   

    for h = 1, 4 do
       
        ui.set_visible(new_menu_references["bruteforce"][h],ui.get(tab_coded) == "AA2" and bruteforce_page)
    end

    --visuals
    --ui.set_visible(new_menu_references["visuals"].visual_label,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].zeus,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].enable_indicators,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].draw_logs,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].indicator_color,ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].enable_indicators) ~= "off")
    ui.set_visible(new_menu_references["visuals"].scoped_animation,ui.get(tab_coded) == "Visuals" )
    ui.set_visible(new_menu_references["visuals"].indicator_manual_color,ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].enable_manual) ~= "off")
    ui.set_visible(new_menu_references["visuals"].enable_manual,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].enable_min_dmg_ovrrd,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].enable_desync_indicator,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].enable_velocity_adaptive, ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].enable_manual) ~= "off")
    ui.set_visible(new_menu_references["visuals"].enable_defensive_indicator,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].slow_indicator,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].indicator_desync_color,ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].enable_desync_indicator))
    ui.set_visible(new_menu_references["visuals"].indicator_defensive_color,ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].enable_defensive_indicator))
    ui.set_visible(new_menu_references["visuals"].indicator_slow_color,ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].slow_indicator))
    ui.set_visible(new_menu_references["visuals"].aim_logs_label, ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].aimer_legs))
    ui.set_visible(new_menu_references["visuals"].aim_logs_outline_color, ui.get(tab_coded) == "Visuals" and ui.get(new_menu_references["visuals"].aimer_legs))
    ui.set_visible(new_menu_references["visuals"].watermark_color, ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].watermark_label, ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].extra_visuals,ui.get(tab_coded) == "Visuals")
    ui.set_visible(new_menu_references["visuals"].noti_timer,ui.get(tab_coded) == "Visuals" and (ui.get(new_menu_references["visuals"].aimer_legs) or ui.get(new_menu_references["visuals"].whatsappi)))
    ui.set_visible(new_menu_references["visuals"].noti_padding,ui.get(tab_coded) == "Visuals" and  ui.get(new_menu_references["visuals"].whatsappi))
    
    --misc
    --ui.set_visible(new_menu_references["misc"].misc_label,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].enable_clan_tag,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].enable_kill_say,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].enable_sun_rise,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].enable_nigthermode,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].enable_local_animations,ui.get(tab_coded) == "Misc")
    ui.set_visible(new_menu_references["misc"].safe_point,ui.get(tab_coded) == "Misc" and table_contains(ui.get(new_menu_references["misc"].debug_ragebot),"safe point enhancer") and (obex_data.build == "private" or obex_data.build == "Private"))
    ui.set_visible(new_menu_references["misc"].debug_ragebot,ui.get(tab_coded) == "Misc" and (obex_data.build == "private" or obex_data.build == "Private"))

    --config
    --ui.set_visible(new_menu_references.config.config_label,ui.get(tab_coded) == "Config")
    ui.set_visible(new_menu_references.config.export_file,ui.get(tab_coded) == "Config")
    ui.set_visible(new_menu_references.config.import_config,ui.get(tab_coded) == "Config")
end
